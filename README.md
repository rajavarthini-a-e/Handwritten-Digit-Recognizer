...
2. Train a Shallow Neural Network.
3. Save the trained model.
4. Upload a handwritten digit image.
5. Preprocess the uploaded image.
...
| Input | Action |
|-------|--------|
| Uploaded Digit Image | Preprocessed to 28x28 Grayscale |
| Processed Image | Flattened into 784-dimensional Vector |
| Trained Model | Predicts Digit (0-9) |
| Softmax Output | Generates Confidence Score |
